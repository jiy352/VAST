...
# load PAV htail 16*6
tail_half = np.swapaxes(np.loadtxt('tail.txt').reshape(ny_tail,nx_tail,3), 0, 1)
...
print('panel_area_wing',sim['panel_area_wing']) 
print('panel_area_tail',sim['panel_area_tail'])

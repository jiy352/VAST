...
def run_fixed(span,num_nodes,frame='wing_fixed'):
    ...
    delta_t_csdl = model.create_input('delta_t', val = delta_t)
    model.register_output('h',csdl.expand(delta_t_csdl, (num_nodes-1)))

...
# @profile
def run_pitching_theodorsen_verification(k,num_nodes,N_period,A=1,save_results=False, save_vtk=False, path = "verfication_data/theodorsen",save_sim=False):
    '''
    ...
    delta_t = model.create_input('delta_t', delta_t_val)
    model.register_output('h',csdl.expand(delta_t, (num_nodes-1)))
...
if __name__ == '__main__':
    ...
    sim = run_pitching_theodorsen_verification(k=1,num_nodes=num_nodes,N_period=N_period,A=A,save_vtk=False,save_sim=True)

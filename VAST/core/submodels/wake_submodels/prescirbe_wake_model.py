...
class PrescribeWakeCoords(Model):
    """
    ...
    def define(self):
        ...
        for i in range(len(surface_names)):
            ...
            wake_coords_name = wake_coords_names[i]
            ...
            # shift the TE coords by delta_t

            wake_coords = self.create_output(wake_coords_name,shape=(num_nodes, n_wake_pts_chord, num_pts_span, 3))

            for i in range(num_nodes):
                wake_coords_temp = csdl.expand(TE, (num_nodes, n_wake_pts_chord, num_pts_span, 3), 'ijk->iljk')
...
if __name__ == "__main__":
    ...
    model_1.add(PrescribeWakeCoords(

...
class RotateToWindFrame(csdl.CustomExplicitOperation):
    """
    ...
    def define(self):
        ...
        # pretty cheap.
        self.declare_derivatives("*", "alpha", method="cs")
        self.declare_derivatives("*", "beta", method="cs")
        ...
        self.declare_derivatives("coll_pts_w_frame", "coll_pts", rows=rows, cols=cols)
        self.declare_derivatives("force_pts_w_frame", "force_pts", rows=rows, cols=cols)
        self.declare_derivatives("bound_vecs_w_frame", "bound_vecs", rows=rows, cols=cols)

        if rotational:
            self.declare_derivatives("rotational_velocities_w_frame", "rotational_velocities", rows=rows, cols=cols)
        ...
        for surface in surfaces:
            ...
            self.declare_derivatives(of_name, wrt_name, rows=rows, cols=cols)
...
class RotateFromWindFrame(csdl.CustomExplicitOperation):
    """

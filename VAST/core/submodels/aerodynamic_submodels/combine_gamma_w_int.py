...
class CombineGammaW(Model):
    ...
    def define(self):
        ...
        gamma_w = self.create_output('gamma_w_int', shape=gamma_w_shape)
        ...
        for i in range(len(surface_shapes)):
            ...
            surface_gamma_w = self.declare_variable(surface_names[i]+'gamma_w_int',shape=surface_gamma_w_shapes[i])
